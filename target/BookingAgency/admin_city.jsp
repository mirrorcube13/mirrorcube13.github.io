...
<main>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <input name="cityId" type="text" class="form-control" id="inputCityId" placeholder="Id" data-bind="value: $data.selectedCity().id" disabled>

                    <label for="inputCityName">Name</label>
                    <input name="cityName" type="text" class="form-control" id="inputCityName" placeholder="Name" data-bind="value: $data.selectedCity().name">
                    ...
                    <label for="inputCityPhoto">Photo</label>
                    <input name="cityPhoto" type="text" class="form-control" id="inputCityPhoto" placeholder="Photo" data-bind="value: $data.selectedCity().photo">
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                    <button type="button" class="btn btn-primary" data-bind="click: $data.updateCity.bind($data)">Save changes</button>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <input name="cityName" type="text" class="form-control" id="cityName" placeholder="Name" data-bind="value: $data.selectedCity().name">
                    ...
                    <label for="cityPhoto">Photo</label>
                    <input name="cityPhoto" type="text" class="form-control" id="cityPhoto" placeholder="Photo" data-bind="value: $data.selectedCity().photo">
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                    <button type="button" class="btn btn-primary" data-bind="click: $data.createCity.bind($data)">Create city</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="panel panel-default">
        <div class="panel-heading"><h3>Cities configuration page</h3>
            <button type="button" class="btn btn-success" data-bind="click: $data.createCityModal">Create city</button>
        </div>
        <table class="table">
            <thead>
            <tr>
            ...
            <tr>
                <td><img width="100%" data-bind="attr: {src: $data.photo}"></td>
                <td><h3 data-bind="text: $data.name"></h3></td>
                <td>
                    <div class="btn-group btn-group-sm city-name-button" role="group" aria-label="...">
                        <button type="button" class="btn btn-warning" data-bind="click: $parent.editCityModal.bind($data)">
                            Edit
                        </button>
                        <button type="button" class="btn btn-danger" data-bind="click: $parent.deleteCityModal.bind($data)">
                            Delete
                        </button>
                        <a type="button" class="btn btn-success" data-bind="attr: {'href' : '/apartment.jsp?id='+$data.id}">
                            Show
                        </a>
                    </div>
                </td>
