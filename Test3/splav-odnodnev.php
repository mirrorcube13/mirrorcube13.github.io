...
<div class="header-block">
	<h1>Brodyaga</h1>
	<hr>
	<h3>Однодневный сплав по реке Ислочь</h3>
</div>
...
<div class="container text-block">
	  <h2 class="centered">Однодневный сплав по реке Ислочь</h2>
	  <div class="row alloys-info align-items-center">
	  	<div class="col-lg-6 col-12">
	  		<img src="img/splav/p2.jpg" alt="" class="img-fluid">
	  	</div>
	  	<div class="col-lg-6 col-12">
	  		<h3><i class="fas fa-coins"></i> Стоимость: 85р</h3>
	  		<p><ul>В стоимость входит:
	  			...
	  			<li><i class="fa fa-check green" aria-hidden="true"></i> привал по маршруту</li>
	  		</ul></p>
	  	</div>
	  </div>  	  
</div>
		...
		<div class="row justify-content-center">
			<div class="col-lg-4 col-6">
				<div class="programs-block">
					<a href="alloys1.html">
						<img src="img/splav/p1.jpg" alt="" class="img-fluid">
						<p class="programs-block_text">Экспресс сплав</p>
					</a>
				</div>
			</div>
			<div class="col-lg-4 col-6">
				<div class="programs-block">
					<a href="alloys3.html">
						<img src="img/splav/p3.jpg" alt="" class="img-fluid">
			...
			<div class="col-lg-4 col-6">
				<div class="programs-block">
					<a href="alloys2.html">
						<img src="img/splav/p5.jpg" alt="" class="img-fluid">
			...
			<div class="col-lg-4 col-6">
				<div class="programs-block">
					<a href="alloys3.html">
						<img src="img/splav/p6.jpg" alt="" class="img-fluid">
