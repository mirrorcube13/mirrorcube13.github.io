...
<div class="container text-block">
	<table class="table_price1 caption-top" align="center">
    <caption>Цена проката за сутки (указаны в руб):</caption>
      <tr>
        <th>Тип байдарки</th>
        <th>будние дни</th>
        <th>пятница-воскресенье</th>
      </tr>
      <tr>
        <th scope="row">Traper (комплект: 1 весло + 1 жилет)</th>
        <td>40</td>
        <td>100</td>
      </tr>
      <tr>
        <th scope="row">DAG Tiwok (комплект: 1 весло + 1 жилет)</th>
        <td>45</td>
        <td>110</td>
      </tr>
      <tr>
        <th scope="row">Pro Tour (комплект: 2 весла + 2 жилета)</th>
        <td>50</td>
        <td>130</td>
      </tr>
      <tr>
        <th scope="row">Eoli (комплект: 2 весла + 2 жилета)</th>
        <td>45</td>
        <td>120</td>
      </tr>      
      <tr>
        <th scope="row">Rio (комплект: 2 весла + 2 жилета)</th>
        <td>40</td>
        <td>110</td>
      </tr>
      <tr>
        <th scope="row">Sprinter I (комплект: 2 весла + 2 жилета)</th>
        <td>45</td>
        <td>120</td>
      </tr>
      <tr>
        <th scope="row">Sprinter II (комплект: 2 весла + 2 жилета)</th>
        <td>50</td>
        <td>130</td>
      </tr>
    </table>		
	...
	<div class="row align-items-center">
		<div class="col-lg-6 col-md-6 order-md-2">
			...
			<ul>
                <li>Длина (мм) -3850</li>
                <li>Ширина (мм) -680</li>
                <li>Вес (версия стандарт) -26 кг</li>
                <li>РАЗМЕРЫ КОКПИТА (мм) -940 x 540</li>
                <li>Объем багажника закрытый- L -80</li>
